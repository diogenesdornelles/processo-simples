...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement('ALTER TABLE processo ALTER COLUMN status TYPE status_proc USING status::status_proc');
        DB::statement('ALTER TABLE processo ALTER COLUMN priority TYPE priority_proc USING priority::priority_proc');
    }
